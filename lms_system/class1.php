    ...
    <nav class="navbar" id="myNavbar">
        <div class="dropdown">
            ...
            <div class="dropdownContent" id="dropdownContent"> 
                ...
                <a href="class1.html" class="active">Class One</a>
...
<div class="filter">
    <a href="#" id="tasks" onclick="tasks();">Tasks <img src="Images/black-circle-close-button-png-5.png" id="taskBtn"></a>
    <a href="#" id="announcements" onclick="announcements();">Announcements <img src="Images/black-circle-close-button-png-5.png" id="annBtn"></a>
