                ...
                <ul class="nav navbar-nav ml-auto">';
                 ...
                 if($_SERVER['REQUEST_URI'] == "/index.php"){
                    ...
                    if($_SERVER['REQUEST_URI'] == "/index-log.php" or "/index-log-admin.php"){
					  echo '
                    <li class="nav-item" role="presentation"><a class="nav-link" href="classroom.php">Classroom</a></li>';  
                    echo '
					...
					if(isset($_SESSION['username'])){
					    	    	...
					    	    	echo '
                    <li class="nav-item" role="presentation"><a class="nav-link" href="index-log-admin.php">Dashboard</a></li>';
